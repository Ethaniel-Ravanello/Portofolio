...
const Data = [
  {
    ...
    img: Akarashi,
    name: "Akarashi",
    href: "/project/akarashi",
    role: "Front End Developer",
    desc: "A platform that allows gamers to explore a vast library of titles, search for specific games based on their preferences or genres.",
  },
  {
    id: 2,
    img: Movies,
