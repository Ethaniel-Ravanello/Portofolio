...
const Section3 = () => {
  ...
  return (
    <section className="snap-start bg-background h-full md:h-screen w-full text-text pt-[200px] px-5 lg:px-28">
      <div className="relative">
        ...
        <div
          key={Data[index].id}
          className="overflow-x-hidden pt-10 text-white block lg:flex items-center justify-center text-5xl transition-all ease-in-out transform translate-x-0 duration-500"
        >
